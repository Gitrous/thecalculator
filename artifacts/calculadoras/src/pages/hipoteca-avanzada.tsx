...
const T = {
  es: {
    ...
    disclaimer: "Esta simulación calcula la cuota, el capital y los intereses según el sistema de amortización francés; no incluye comisiones, seguros ni productos vinculados, por lo que no representa necesariamente el coste total de la hipoteca. Consulta siempre la FEIN y la FIAE que te entrega el banco antes de firmar. Metodología basada en el sistema francés de amortización (referencia: Banco de España).",
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div>
        ...
        <ReviewedNote date="06/09/2026" sources={[{ label: "BOE — Ley 5/2019", href: "https://www.boe.es/buscar/act.php?id=BOE-A-2019-3814" }, { label: "Agencia Tributaria", href: "https://sede.agenciatributaria.gob.es/" }]} className="mt-3 mb-6" />
      </div>
...
registerFaq("finanzas/hipoteca", T);
