...
const T = {
  es: {
    ...
    disclaimer: "Los resultados son orientativos. Son zonas estimadas y no determinan por sí solas una intensidad segura para personas con enfermedad cardiovascular o que tomen medicación que altere la frecuencia cardíaca (por ejemplo, betabloqueantes). Consulta a un médico o profesional del deporte antes de iniciar programas de entrenamiento de alta intensidad. Referencia: Tanaka H, Monahan KD, Seals DR. Age-predicted maximal heart rate revisited. J Am Coll Cardiol. 2001.",
    cardTitle: "Tu edad",
    ageLabel: "Edad (años)",
  ...
  en: {
    ...
    disclaimer: "Results are indicative only. These are estimated zones and do not by themselves determine a safe intensity for people with cardiovascular disease or taking medication that alters heart rate (for example, beta blockers). Consult a doctor or sports professional before starting high-intensity training programmes. Reference: Tanaka H, Monahan KD, Seals DR. Age-predicted maximal heart rate revisited. J Am Coll Cardiol. 2001.",
    cardTitle: "Your age",
    ageLabel: "Age (years)",
