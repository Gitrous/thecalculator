...
const T = {
  es: {
    ...
    disclaimer: "Los resultados son estimaciones basadas en la potencia nominal y el uso declarado. La potencia nominal (los vatios de la etiqueta) es el máximo que demanda el aparato; si funciona por ciclos (como un frigorífico), el consumo real suele ser menor. Introduce el precio del kWh de tu tarifa y consulta tu factura para el importe exacto.",
    tarifaTitle: "Tarifa Eléctrica",
    countryLabel: "País",
    priceLabel: "Precio por kWh (€)",
    priceHint: "Valor prefijado orientativo, no una tarifa vigente ni verificada: el precio real depende de tu comercializadora, tu tarifa y la franja horaria. Cámbialo por el de tu última factura para que el resultado sea el tuyo.",
  ...
  en: {
    ...
    disclaimer: "Results are estimates based on nominal power and declared usage. Nominal power (the watts on the label) is the maximum the appliance draws; if it runs in cycles (like a fridge), actual consumption is usually lower. Enter your tariff's price per kWh and check your bill for the exact amount.",
    tarifaTitle: "Electricity Tariff",
    countryLabel: "Country",
    priceLabel: "Price per kWh (€)",
    priceHint: "An indicative preset, not a current or verified tariff: the real price depends on your supplier, your plan and the time of day. Replace it with the figure from your latest bill so the result is actually yours.",
