...
const T = {
  es: {
    ...
    pricePeriod: "Estimaciones orientativas para 2025-2026",
    priceSource: "Estos importes son estimaciones orientativas de precios habituales de mercado. No proceden de una tarifa oficial, de un índice publicado ni de un proveedor concreto, y por eso esta página no lleva fecha de revisión de datos como sí la llevan nuestras calculadoras basadas en normativa: no hay una fuente contra la que verificarlos. Úsalos solo como orden de magnitud y pide siempre al menos tres presupuestos.",
    ...
    howText: "Los rangos reflejan los precios medios del sector de la construcción en España (2025-2026), incluyendo materiales y mano de obra. El precio mínimo corresponde a acabados económicos y el máximo a calidades medias-altas. Los precios no incluyen IVA: determinadas obras de renovación y reparación de vivienda pueden acogerse al tipo reducido del 10 % si cumplen los requisitos legales; en los demás casos se aplica el tipo general del 21 %.",
    faqTitle: "Preguntas frecuentes",
    q1: "¿El precio incluye IVA?",
    a1: "No. Los precios son sin IVA. Determinadas obras de renovación y reparación en vivienda pueden tributar al tipo reducido del 10 % si cumplen los requisitos legales (por ejemplo, que la vivienda tenga cierta antigüedad y que el coste de los materiales aportados por la empresa no supere un porcentaje de la base imponible); en los demás casos, y en segundas viviendas o locales, se aplica el 21 %. Añade el IVA que corresponda al presupuesto final para calcular el coste total.",
  ...
  en: {
    ...
    pricePeriod: "Indicative estimates for 2025-2026",
    priceSource: "These amounts are indicative estimates of typical market prices. They do not come from an official price list, a published index or a specific supplier, which is why this page carries no data review date as our regulation-based calculators do: there is no source to check them against. Treat them as an order of magnitude only, and always get at least three quotes.",
    ...
    howText: "The ranges reflect average construction sector prices in Spain (2025-2026), including materials and labour. The minimum price corresponds to budget finishes and the maximum to medium-high quality. Prices do not include VAT: certain home renovation and repair works may qualify for the reduced 10% rate if they meet the legal requirements; otherwise the standard 21% rate applies.",
    faqTitle: "Frequently asked questions",
    q1: "Do prices include VAT?",
    a1: "No. Prices exclude VAT. Certain home renovation and repair works may be taxed at the reduced 10% rate if they meet the legal requirements (for example, a minimum age of the dwelling and a cap on the cost of materials supplied by the company relative to the taxable base); otherwise, and for second homes or commercial premises, the 21% rate applies. Add the relevant VAT to the final budget to calculate the total cost.",
