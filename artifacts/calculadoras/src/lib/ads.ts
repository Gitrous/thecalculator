// Publisher ID (AdSense account)
export const AD_CLIENT = "ca-pub-1123812992313934";

// Slot IDs — create these in AdSense → Mis anuncios → Por unidad de anuncio → Anuncio de display (responsive)
