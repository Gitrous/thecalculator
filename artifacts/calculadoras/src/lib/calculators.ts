...
export const CALCULATORS: CalculatorMeta[] = [
  ...
  // ── Trabajo ───────────────────────────────────────────────────────────────
  {
    ...
    enTitle: "Finiquito Calculator (Spain) — Final Settlement",
  ...
  // ── Trabajo (nuevas) ──────────────────────────────────────────────────────
  {
    ...
    description:
      "Estima tu prestación contributiva por desempleo según tu base reguladora y los días cotizados: cuantía, duración y total.",
    shortLabel: "Paro / Desempleo",
    icon: DollarSign,
    color: "text-indigo-600 bg-indigo-100 dark:bg-indigo-900/30",
    seoTitle: "Calculadora de Paro y Prestación por Desempleo 2026",
    seoDescription:
      "Estima tu prestación contributiva por desempleo según tu base reguladora y los días cotizados. Incluye cuantía mensual, duración y total.",
